...
2. **CLI Services** - Master Git, Supabase CLI, and development workflows
3. **Planning Worksheet** - Transform ideas into structured requirements
4. **Build with AI Flow** - The complete systematic workflow
5. **Self-Hosting 101** - Deploy to your own infrastructure (advanced)
